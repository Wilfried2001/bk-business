...
function roleBadge(string $role): string {
    ...
    return "<span class='app-badge app-badge-" . e($color) . "'>" . e($role) . "</span>";
}

// Badge couleur selon le statut d'alerte
function alerteBadge(string $statut): string {
    $color = $statut === 'ACTIVE' ? 'danger' : 'success';
    return "<span class='app-badge app-badge-" . e($color) . "'>" . e($statut) . "</span>";
}
...
function mouvementBadge(string $nature): string {
    ...
    $icon  = $nature === 'CREDIT' ? '↑' : '↓';
    return "<span class='app-badge app-badge-" . e($color) . "'>" . e($icon . ' ' . $nature) . "</span>";
}
